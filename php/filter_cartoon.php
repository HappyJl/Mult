...
<div id="filter-box">
        ...
        <div class="mult-block">
            <?php
            include 'db.php';
            include_once "../pagination/pagination_cartoon.php";

            $result = mysqli_query($connect,"SELECT * FROM `cartoon` ORDER BY `Рейтинг мультфильма` DESC LIMIT {$offset},{$forms_page}");
    ...
    <div class = "pagination">
        ...
        for ($i = 1; $i <= $total_pages; $i++){
            echo "<div class= pagination_style>  <a href='filter_cartoon.php?page=".$i."'>".$i."</a></div>";
        }
        ?>
    </div>
</div>
